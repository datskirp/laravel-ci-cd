...
@section('content')
    ...
    <div class="grid h-top place-items-center">
        ...
        <form  method="post" action="{{ route('service.store') }}" novalidate
               class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            @csrf

            <div class="mb-2">
                <label class="font-semibold">Type </label><br>
                <input type="text" class="border @error('type')  border-pink-500 text-pink-500 @enderror" name="type"
                       id="type">
            ...
            <div class="mb-2">
                ...
                <input type="text" class="border @error('deadline')  border-pink-500 text-pink-500 @enderror "
